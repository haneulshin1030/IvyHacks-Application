...
module.exports = function (router) {
  ...
  router.get('/users/exportcsv', isAdmin, function (req, res, next) {
    ...
    var fields = ['_id', 'email', 'verified', 'timestamp', 'lastUpdated',
      'profile.name', 'profile.timezone', 'profile.degree', 'profile.school',
      'profile.graduationYear', 'profile.major', 'profile.gender', 'profile.race',
      'profile.experience', 'profile.tracks', 'profile.background', 'profile.proud',
      'profile.whyivyhacks', 'status.name', 'status.completedProfile', 'status.admitted',
